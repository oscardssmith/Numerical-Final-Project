...
println(getTimes(2 .^(5:11),Int64,20,strassenNaiveRecurse))
println("One-Layer Base Mult")
println(getTimes(2 .^(5:11),Int64,20,strassenNoRecurse))
println("One-Layer Naive Mult")
println(getTimes(2 .^(5:11),Int64,20,strassenNaiveNoRecurse))
println("Base")
println(getTimes(2 .^(5:11),Int64,20,mult))
println("Blocked Mult")
println(getTimes(2 .^(5:11),Int64,20,blockedMult))
println("One-Layer Blocked Mult")
println(getTimes(2 .^(5:11),Int64,20,strassenStripedNoRecurse))
println("Recursive Blocked Mult")
println(getTimes(2 .^(5:11),Int64,20,strassenStripedRecurse))
...
println("base")
println(getTimes(2 .^(5:11),Float64,1,mult))
println("One-layer")
println(getTimes(2 .^(5:11),Float64,1,strassenNoRecurse))
println("Recursive")
println(getTimes(2 .^(5:11),Float64,1,strassenRecurse))
